...
@inject
async def handle_task_created(msg: bytes, service: FromDishka[NotificationService]) -> None:
...
@inject
async def handle_task_updated(msg: bytes, service: FromDishka[NotificationService]) -> None:
    task = Task.model_validate_json(msg)
...
@inject
async def handle_task_deleted(msg: bytes, service: FromDishka[NotificationService]) -> None:
    task = Task.model_validate_json(msg)
